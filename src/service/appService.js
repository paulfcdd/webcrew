...
function servicesItemsList($q) {
    ...
    var cItems = [
        ...
        },
        {
            ...
            ' но и позитивно скажется на ранжировании Вашего сайта при выдаче в поисковых системах. Наши копирайтеры знают, как писать по-настоящему интересные, для людей и поисковых роботов, тексты, ' +
